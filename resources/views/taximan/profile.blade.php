...
@section('content')
    ...
    <main class="max-w-2xl mx-auto px-4 sm:px-6 py-10">
        <a href="{{ route('taximan.dashboard') }}" class="text-sm text-gray-500 hover:text-nuit">&larr; Tableau de bord</a>
        <h1 class="mt-2 text-2xl font-semibold text-nuit mb-6">Mon profil</h1>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6">
            <form method="POST" action="{{ route('taximan.profile.update') }}">
                ...
                <h2 class="text-sm font-semibold text-nuit mb-3">Coordonnées</h2>
                <div class="space-y-4">
                ...
                <h2 class="text-sm font-semibold text-nuit mt-6 mb-3">Informations chauffeur</h2>
                <div class="space-y-4">
                    <div>
                    ...
                    <div>
                        ...
                        <textarea id="bio" name="bio" rows="4"
                                  class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-lagon focus:ring-lagon focus:outline-none focus:ring-1">{{ old('bio', $profile->bio ?? '') }}</textarea>
                    </div>
