...
@section('content')
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <h1 class="text-2xl font-semibold text-nuit">Bonjour {{ auth()->user()->first_name }}</h1>
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-3">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-5">
                <div class="text-3xl font-semibold text-nuit">{{ $stats['mes_visites'] }}</div>
                <div class="mt-1 text-sm text-gray-500">Mes visites</div>
            </div>
            <div class="rounded-lg border border-gray-200 bg-white p-5">
                <div class="text-3xl font-semibold text-nuit">{{ $stats['chauffeurs'] }}</div>
