...
@section('content')
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-5">
                <div class="text-3xl font-semibold text-gray-900">{{ $stats['transports'] }}</div>
                <div class="mt-1 text-sm text-gray-500">Transports</div>
            </div>
            <div class="rounded-lg border border-gray-200 bg-white p-5">
                <div class="text-3xl font-semibold text-gray-900">{{ $stats['taximen'] }}</div>
                <div class="mt-1 text-sm text-gray-500">Chauffeurs</div>
            </div>
            <div class="rounded-lg border border-gray-200 bg-white p-5">
                <div class="text-3xl font-semibold text-gray-900">{{ $stats['visiteurs'] }}</div>
        ...
        <div class="mt-6 grid gap-4 sm:grid-cols-2">
            <a href="{{ route('admin.destinations.index') }}"
               class="block rounded-lg border border-gray-200 bg-white p-5 hover:border-gray-400 transition">
                <h2 class="text-sm font-semibold text-gray-900">Gérer les destinations</h2>
            ...
            <a href="{{ route('admin.transports.index') }}"
               class="block rounded-lg border border-gray-200 bg-white p-5 hover:border-gray-400 transition">
                <h2 class="text-sm font-semibold text-gray-900">Gérer les transports</h2>
