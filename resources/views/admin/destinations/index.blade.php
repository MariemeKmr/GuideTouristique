                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right text-sm">
                                <div class="flex items-center justify-end gap-1.5">
                                    <a href="{{ route('admin.destinations.edit', $destination) }}" title="Modifier"
                                    ...
                                    <form method="POST" action="{{ route('admin.destinations.destroy', $destination) }}" onsubmit="return confirm('Supprimer cette destination ?');">
                                        @csrf
                                        @method('DELETE')
