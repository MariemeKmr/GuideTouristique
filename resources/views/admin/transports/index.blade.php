...
@section('content')
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-nuit">Transports</h1>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right text-sm">
                                <div class="flex items-center justify-end gap-1.5">
                                    <a href="{{ route('admin.transports.edit', $transport) }}" title="Modifier"
                                    ...
                                    <form method="POST" action="{{ route('admin.transports.destroy', $transport) }}" onsubmit="return confirm('Supprimer ce transport ?');">
                                        @csrf
                                        @method('DELETE')
