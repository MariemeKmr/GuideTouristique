...
@section('content')
    <h1 class="text-xl font-semibold text-nuit mb-1">Créer un compte</h1>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <select id="role" name="role" required
                    class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm bg-white focus:border-lagon focus:ring-lagon focus:outline-none focus:ring-1">
    ...
    <p class="mt-6 text-center text-sm text-gray-500">
        Déjà inscrit ?
        <a href="{{ route('login') }}" class="font-medium text-nuit hover:underline">
            Se connecter
        </a>
    </p>
@endsection
